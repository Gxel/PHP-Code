...
<tr>
	...
	<tr>
		<? if ($onbox == '1') { ?>
		<td class="pfadfocus" colspan="11">
			<a href="<? echo $PHP_SELF . '?dir1=' . $dir1 . '&onbox=1'; ?>">
				<font color="#FFFFFF"><? echo $d->path; ?></font>
			</a>
		</td>
		<? }else{ ?>
		<td class="pfad" colspan="11">
			<a href="<? echo $PHP_SELF . '?dir1=' . $dir1 . '&onbox=1'; ?>">
				<font color="#D9D9CC"><? echo $d->path; ?></font>
			</a>
		</td>		
		<? } ?>
	</tr>
	...
	<tr>
		<? if ($onbox == '2') { ?>
		<td class="pfadfocus" colspan="11">
			<a href="<? echo $PHP_SELF . '?dir2=' . $dir2 . '&onbox=2'; ?>">
				<font color="#FFFFFF"><? echo $d->path; ?></font>
			</a>
		</td>
		<? }else{ ?>
